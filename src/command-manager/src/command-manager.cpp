...
command_manager::command_manager(
    ...
    socket_transport_layer *socket, const char *send_cmd_socket_path)
    : communications_layer(communications_layer), socket(socket),
      send_cmd_socket_path(send_cmd_socket_path), fast_cmd_observer(nullptr),
      slow_cmd_observer(nullptr), shutdown_cmd_observer(nullptr) {}
...
int command_manager::send_slow_cmd(char *response_buffer,
...
void command_manager::subscribe_fast_cmd(command_observer *observer) {
  fast_cmd_observer = observer;
}

void command_manager::subscribe_slow_cmd(command_observer *observer) {
  slow_cmd_observer = observer;
}

void command_manager::subscribe_shutdown_cmd(command_observer *observer) {
  shutdown_cmd_observer = observer;
}

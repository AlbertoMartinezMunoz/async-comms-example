...
public:
    virtual void SetUp()
    {
        ...
        command_mng = new command_manager(application_layer_mock, transport_layer_mock);
...
{
    EXPECT_CALL(*application_layer_mock, send(StrEq(expected_fast_command), sizeof(expected_fast_command)))
        .Times(1)

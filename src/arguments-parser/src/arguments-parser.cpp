...
static char doc[] = "command-manager send receives messages using a unix socket";
...
const char *arguments_parser::get_local_path(void) { return local_path.c_str(); }

const char *arguments_parser::get_remote_path(void) { return remote_path.c_str(); }

...
local_fast_command::local_fast_command(local_command_receiver *cmd_rcv)
    : cmd_rcv(cmd_rcv) {}
...
local_slow_command::local_slow_command(local_command_receiver *cmd_rcv)
    : cmd_rcv(cmd_rcv) {}
...
local_shutdown_command::local_shutdown_command(local_command_receiver *cmd_rcv,
